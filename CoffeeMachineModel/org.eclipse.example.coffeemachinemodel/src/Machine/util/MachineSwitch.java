...
public class MachineSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MachinePackage.COMPONENT: {
				Component component = (Component)theEObject;
				T result = caseComponent(component);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MachinePackage.WATER_TANK: {
			...
			case MachinePackage.COFFEE_MAKER: {
				CoffeeMaker coffeeMaker = (CoffeeMaker)theEObject;
				T result = caseCoffeeMaker(coffeeMaker);
				if (result == null) result = caseComponent(coffeeMaker);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MachinePackage.GRINDER: {
				Grinder grinder = (Grinder)theEObject;
				T result = caseGrinder(grinder);
				if (result == null) result = caseComponent(grinder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MachinePackage.MILK_FROTHER: {
				MilkFrother milkFrother = (MilkFrother)theEObject;
				T result = caseMilkFrother(milkFrother);
				if (result == null) result = caseComponent(milkFrother);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MachinePackage.COFFEE_MACHINE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Grinder</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Grinder</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGrinder(Grinder object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Milk Frother</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Milk Frother</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMilkFrother(MilkFrother object) {
		return null;
	}
