...
public class StudentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Student_editions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Student_editions_feature", "_UI_Student_type"),
				 UniversityPackage.Literals.STUDENT__EDITIONS,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Student Id feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addStudentIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Student_studentId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Student_studentId_feature", "_UI_Student_type"),
				 UniversityPackage.Literals.STUDENT__STUDENT_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDateOfBirthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Student_dateOfBirth_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Student_dateOfBirth_feature", "_UI_Student_type"),
				 UniversityPackage.Literals.STUDENT__DATE_OF_BIRTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
