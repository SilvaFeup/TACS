...
public class UniversityItemProviderAdapterFactory extends UniversityAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link university.StaffEdition} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected StaffEditionItemProvider staffEditionItemProvider;

	/**
	 * This creates an adapter for a {@link university.StaffEdition}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createStaffEditionAdapter() {
		if (staffEditionItemProvider == null) {
			staffEditionItemProvider = new StaffEditionItemProvider(this);
		}

		return staffEditionItemProvider;
	}
	...
	public void dispose() {
		...
		if (staffEditionItemProvider != null) staffEditionItemProvider.dispose();
	}
