...
public class GradeImpl extends MinimalEObjectImpl.Container implements Grade {
		...
		if (student != null && student.eIsProxy()) {
			...
			if (student != oldStudent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UniversityPackage.GRADE__STUDENT, oldStudent, student));
			}
		}
		return student;
	}
	...
	public void setStudent(Student newStudent) {
		...
		student = newStudent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UniversityPackage.GRADE__STUDENT, oldStudent, student));
	}
	...
	public void setEdition(Edition newEdition) {
		...
		edition = newEdition;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UniversityPackage.GRADE__EDITION, oldEdition, edition));
	}
