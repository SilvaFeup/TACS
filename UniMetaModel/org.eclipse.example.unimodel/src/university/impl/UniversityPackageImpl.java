...
public class UniversityPackageImpl extends EPackageImpl implements UniversityPackage {
	 ...
	 * @generated
	 */
	private EClass staffEditionEClass = null;
	 ...
	 */
	@Override
	public EAttribute getUniversity_EstablishedYear() {
	 ...
	 */
	@Override
	public EAttribute getFaculty_Dean() {
		return (EAttribute)facultyEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EReference getDegree_Faculty() {
	 ...
	 */
	@Override
	public EAttribute getDegree_Description() {
	 ...
	 */
	@Override
	public EAttribute getDegree_DurationYears() {
	 ...
	 */
	@Override
	public EReference getCourse_Degree() {
	 ...
	 */
	@Override
	public EReference getEdition_Course() {
	 ...
	 */
	@Override
	public EReference getEdition_Staff() {
	 ...
	 */
	@Override
	public EAttribute getEdition_Semester() {
	 ...
	 */
	@Override
	public EAttribute getEdition_StartDate() {
	 ...
	 */
	@Override
	public EReference getStudent_Editions() {
	 ...
	 */
	@Override
	public EReference getProfessor_Editions() {
	 ...
	 */
	@Override
	public EAttribute getProfessor_EmployeeId() {
	 ...
	 */
	@Override
	public EClass getStaffEdition() {
		return staffEditionEClass;
	}
	 ...
	 */
	@Override
	public EReference getStaffEdition_Professors() {
		return (EReference)staffEditionEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(universityEClass, UNIVERSITY__ESTABLISHED_YEAR);
		...
		createEAttribute(facultyEClass, FACULTY__DEAN);

		degreeEClass = createEClass(DEGREE);
		createEReference(degreeEClass, DEGREE__FACULTY);
		createEReference(degreeEClass, DEGREE__COURSES);
		createEAttribute(degreeEClass, DEGREE__NAME);
		createEAttribute(degreeEClass, DEGREE__DESCRIPTION);
		createEAttribute(degreeEClass, DEGREE__DURATION_YEARS);

		courseEClass = createEClass(COURSE);
		createEReference(courseEClass, COURSE__DEGREE);
		...
		createEReference(editionEClass, EDITION__COURSE);
		createEReference(editionEClass, EDITION__STUDENTS);
		createEReference(editionEClass, EDITION__STAFF);
		createEAttribute(editionEClass, EDITION__SEMESTER);
		createEAttribute(editionEClass, EDITION__YEAR);
		createEAttribute(editionEClass, EDITION__START_DATE);

		studentEClass = createEClass(STUDENT);
		createEReference(studentEClass, STUDENT__EDITIONS);
		...
		createEReference(professorEClass, PROFESSOR__EDITIONS);
		createEAttribute(professorEClass, PROFESSOR__NAME);
		createEAttribute(professorEClass, PROFESSOR__EMPLOYEE_ID);
		...
		staffEditionEClass = createEClass(STAFF_EDITION);
		createEReference(staffEditionEClass, STAFF_EDITION__PROFESSORS);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getUniversity_Location(), ecorePackage.getEString(), "location", null, 0, 1, University.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUniversity_EstablishedYear(), ecorePackage.getEInt(), "establishedYear", null, 0, 1, University.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(facultyEClass, Faculty.class, "Faculty", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFaculty_University(), this.getUniversity(), null, "university", null, 1, 1, Faculty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFaculty_Dean(), ecorePackage.getEString(), "dean", null, 0, 1, Faculty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(degreeEClass, Degree.class, "Degree", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDegree_Faculty(), this.getFaculty(), null, "faculty", null, 1, 1, Degree.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDegree_Courses(), this.getCourse(), null, "courses", null, 0, -1, Degree.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDegree_Description(), ecorePackage.getEString(), "description", null, 0, 1, Degree.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDegree_DurationYears(), ecorePackage.getEInt(), "durationYears", null, 0, 1, Degree.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(courseEClass, Course.class, "Course", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCourse_Degree(), this.getDegree(), null, "degree", null, 1, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEdition_Course(), this.getCourse(), null, "course", null, 1, 1, Edition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEdition_Staff(), this.getStaffEdition(), null, "staff", null, 1, 1, Edition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEdition_Semester(), ecorePackage.getEString(), "semester", null, 0, 1, Edition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEdition_StartDate(), ecorePackage.getEDate(), "startDate", null, 0, 1, Edition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(studentEClass, Student.class, "Student", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getStudent_Editions(), this.getEdition(), null, "editions", null, 0, -1, Student.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStudent_StudentId(), ecorePackage.getEString(), "studentId", null, 0, 1, Student.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getStudent_DateOfBirth(), ecorePackage.getEDate(), "dateOfBirth", null, 0, 1, Student.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(professorEClass, Professor.class, "Professor", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getProfessor_Editions(), this.getEdition(), null, "editions", null, 0, -1, Professor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProfessor_EmployeeId(), ecorePackage.getEString(), "employeeId", null, 0, 1, Professor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProfessor_Email(), ecorePackage.getEString(), "email", null, 0, 1, Professor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGrade_Value(), ecorePackage.getEDouble(), "value", null, 0, 1, Grade.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(staffEditionEClass, StaffEdition.class, "StaffEdition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getStaffEdition_Professors(), this.getProfessor(), null, "professors", null, 0, -1, StaffEdition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
