...
public class UniversityAdapterFactory extends AdapterFactoryImpl {
	...
	protected UniversitySwitch<Adapter> modelSwitch =
		new UniversitySwitch<Adapter>() {
			...
			@Override
			public Adapter caseStaffEdition(StaffEdition object) {
				return createStaffEditionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link university.StaffEdition <em>Staff Edition</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createStaffEditionAdapter() {
		return null;
	}
